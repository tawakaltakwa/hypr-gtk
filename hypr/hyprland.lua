...
-- Warna / color preset (dipisah ke file tersendiri)
require("warna")
...
hl.config({
    general = {
        ...
        -- Warna border diatur di warna.lua
...
local menu        = "wofi -s ~/.config/hypr/wofi/styles.css --show drun -I -G -W 40%"
...
hl.bind(mainMod .. " + ALT + Delete", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
hl.bind(mainMod .. " + CTRL + N", hl.dsp.layout("consume"))
hl.bind(mainMod .. " + CTRL + M", hl.dsp.layout("expel"))
--hl.bind(mainMod .. " + SHIFT + F", hl.dsp.layout("colresize -conf")) -- ke arah sebaliknya
...
hl.window_rule({ 
    match = { class = "^(A|a)ntigravity-ide" },
    scrolling_width = 1.0
})

hl.window_rule({ 
    match = { class = "^(F|f)irefox" },
    scrolling_width = 1.0
})
